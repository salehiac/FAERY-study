...
for k_fig in params["filerange"]:
    ...
    for prefix in ("test", "train"):
        ...
        graph_filled(ax=axs[1],
                     ...
                     list_colors_couple=[params["colors"][prefix]],
                     list_labels=[prefix],
                     xlabel="Generation",
    ...
    plt.suptitle(params["title"].format(k_fig))

    plt.savefig("data/Images/assembly-v2/no_stop/{}.png".format(params["save_basename"].format(k_fig)))
