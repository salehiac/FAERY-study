...
import problem.environments.maze_generator.maze_generator as maze_generator
...
class HardMaze(Problem):
    ...
    def __init__(self,
        ...
        # Note that the diameter returned by self.env.goal.get_diam() is 7.0 by default (which would be 21.0 in the 200x200 image). I'm doubling that for faster experiments.
        self.goal_radius = 42
